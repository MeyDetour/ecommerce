 ...
 */
final class Version20240428095507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_variant (id INT NOT NULL, product_id INT NOT NULL, number TEXT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD number TEXT NOT NULL');
    }
}
